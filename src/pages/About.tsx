        ...
        <div className="px-6 py-4 md:px-20 md:py-10">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:flex-1">
              ...
              <p className={paragrafClass}>{t("section_about_us.text.3")}</p>
              <p className={paragrafClass}>{t("section_about_us.text.4")}</p>
              <p className={paragrafClass}>{t("section_about_us.text.5")}</p>
            </div>
          </div>
              ...
              {coreValues.map((v, i) => (
                <div key={i} className="flex flex-col items-center text-center space-y-4">
                  <img src={v.img} alt={v.label}/>
                    <p className="text-base md:text-2xl text-white fonts-inter font-normal">{t(v.label)}</p>
                </div>
              ))}
            </div>
          </div>
