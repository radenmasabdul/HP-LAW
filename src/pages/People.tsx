      ...
      <section className="py-10 px-6 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-12 md:gap-10">
          <div className="md:col-span-4 flex flex-col">
            ...
            <div className="py-6">
              <p className="text-xl md:text-2xl text-gold-medium font-semibold fonts-inter">{t(selected.name)}</p>
              <p className="text-base md:text-lg text-white font-normal fonts-inter">{t(selected.title)}</p>
            </div>
          </div>
